...
import type { Migration as _Migration, MigrationData as _MigrationData, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async createEntry(arg0: string, arg1: string, arg2: string, arg3: Array<string>): Promise<string> {
        if (this.processError) {
            try {
    ...
    async deleteEntry(arg0: string): Promise<boolean> {
        if (this.processError) {
            try {
    ...
    async getEntries(): Promise<Array<VaultEntry>> {
        if (this.processError) {
            try {
    ...
    async getEntriesByTag(arg0: string): Promise<Array<VaultEntry>> {
        if (this.processError) {
            try {
                const result = await this.actor.getEntriesByTag(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getEntriesByType(arg0: string): Promise<Array<VaultEntry>> {
        if (this.processError) {
            try {
    ...
    async migrate(arg0: Migration): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.migrate(to_candid_Migration_n6(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateEntry(arg0: string, arg1: string, arg2: string, arg3: Array<string>): Promise<boolean> {
        if (this.processError) {
            try {
...
function to_candid_Migration_n6(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Migration): _Migration {
